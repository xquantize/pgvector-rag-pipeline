...
<!-- source: https://www.postgresql.org/docs/16/datatype-json.html -->
<!-- category: json -->
...
$varname A named variable. Its value can be set by the parameter vars of several JSON processing functions; see Table 9.49 for details. 
...
Prev Up Next 
8.13. XML Type Home 8.15. Arrays
