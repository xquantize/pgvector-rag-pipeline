...
<!-- source: https://www.postgresql.org/docs/16/datatype-numeric.html -->
<!-- category: types -->
...
CREATE SEQUENCE tablename _ colname _seq AS integer;
CREATE TABLE tablename ( colname integer NOT NULL DEFAULT nextval(' tablename _ colname _seq')
);
